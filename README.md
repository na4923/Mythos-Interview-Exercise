...
Any number of columns can be added as long as they have a matching field in template.txt. 
Otherwise they will be ignored. They should be in the following format: [column-name]
